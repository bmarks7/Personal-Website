let skills_list = {'Java': {'level': 75, 'category': 0}, 
                'Python': {'level': 80, 'category': 0},
                'JavaScript': {'level': 85, 'category': 0},
                'C': {'level': 80, 'category': 0},
                'C++': {'level': 80, 'category': 0},
                'HTML': {'level': 90, 'category': 1},
                'CSS': {'level': 90, 'category': 1},
                'React': {'level': 90, 'category': 1},
                'React Native': {'level': 70, 'category': 1},
                'Angular': {'level': 40, 'category': 1},
                'Bootstrap': {'level': 30, 'category': 1},
                'Node.js': {'level': 55, 'category': 2},
                'Express': {'level': 60, 'category': 2},
                'Django': {'level': 65, 'category': 2},
                'Flask': {'level': 55, 'category': 2},
                'SQL': {'level': 60, 'category': 3},
