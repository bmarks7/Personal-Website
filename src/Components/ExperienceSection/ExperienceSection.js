    ...
    render() {
        return (
            <div className="ExperienceSection" data-aos='fade-right'>
                <div className="ExperienceSection__header" onMouseEnter={this.sectionHover} onMouseLeave={this.sectionStopHover} onClick={this.openSection} style={{transform: 'translateY(' + ((this.state.scaleUp) ? ((isMobile) ? -1 : -10) : 0) + 'px)', backgroundColor: this.state.headerColor, boxShadow: this.state.boxShadow, borderRadius: this.state.open ? '15px 15px 0px 0px' : '15px 15px 15px 15px'}}>
